...
const Navbar = () => {
  return (
    <AppBar position="static" className="p-4 flex flex-row justify-between ">
      ...
      <Box className="rotate-45 fixed flex flex-col items-center justify-end -right-[4%] -top-[10%] p-[2%] h-[14vw] w-[14vw] 2xl:h-[12vw] 2xl:w-[12vw] rounded-full bg-gradient-to-tl to-yellow-300 from-yellow-500 transition cursor-pointer hover:shadow-lg hover:shadow-yellow-500">
